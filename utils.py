...
"""plot result"""
def plot_hist(num_epochs, val_hist, train_hist, Loss_or_Accuracy, save_dir):
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig(f'{save_dir}/{Loss_or_Accuracy}.png', transparent=True, bbox_inches='tight', dpi=600)
    plt.cla()
